...
public class PermissionUtil {
     ...
     * 权限提醒
     */
    static String PermissionTip1 = "软件部分功能需要请求您的手机权限，请允许以下权限：\n\n";
    /**
     * 权限提醒
     */
    static String PermissionTip2 = "\n请到 “应用信息 -> 权限” 中授予！";
    static String PermissionDialogPositiveButton = "去手动授权";
    static String PermissionDialogNegativeButton = "取消";

    private static PermissionUtil permissionUtils;

    public static PermissionUtil getInstance() {
        if (permissionUtils == null) {
            permissionUtils = new PermissionUtil();
        }
